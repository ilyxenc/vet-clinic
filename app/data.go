...
// Чтение данных из JSON-файла с переводом в слайс, состоящий из структур Animal
func readDataJSON(id string) []Animal {
	...
	// Объявление слайса из структур Animal
	var data []Animal
	...
	// Возвращение данных в виде слайса, т.к. возвращаемый тип функции - слайс из структур Animal
	return []Animal{item}
}

// Запись данных в JSON-файл
func writeDataJSON(item Animal) error {
	...
	// Преобразование слайса из структур Animal в набор байт, возвращение ошибки в случае, если она есть
...
func updateDataJSON(item Animal) error {
	// Чтение всех данных из исходного файла с данными
	data := readDataJSON("all")
...
func removeAnimalFromSlice(s []Animal, id string) []Animal {
	i := 0
